  ...
  return (
    <BannerWrapper id="banner_section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...row}>
          <Box {...contentArea}>
            <Heading content="Ballarat Mini Excavations" {...nameStyle} />
            <Heading content="For the more delacate work..." {...designationStyle} />
            <Box {...roleWrapper}>
              <Icon
            ...
            <Text
              content="Specialising in small to medium jobs where larger equipment just can't compete."
              {...aboutStyle}
            />
            <SocialProfile items={Data.portfolioJson.SOCIAL_PROFILES} />
          </Box>
          <Box {...imageArea} className="image_area">
            <Image src={MainBanner} alt="Digger Image" />
          </Box>
        </Box>
      </Container>
    </BannerWrapper>
